...
const NetlifyPortfolio: React.FC = () => {
    // Utilisation des données réelles du JSON
    const user: User = portfolioData.user || {
        id: 1,
        name: 'Yacine Atmani',
        first_name: 'Yacine',
        bio: 'Développeur Fullstack passionné par Laravel, React et les technologies modernes.',
        photo: '/storage/profile/photo.jpg',
        cv: '/storage/cv/cv.pdf'
    };
    ...
    useEffect(() => {
        ...
        // Animations GSAP - EXACTEMENT comme dans Home.tsx
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Simulation d'envoi pour version statique
        setTimeout(() => {
    ...
    return (
        <ErrorBoundary>
            ...
            >
                    ...
                    <div style={{ textAlign: 'center', maxWidth: '48rem', margin: '0 auto', padding: '0 1.5rem' }}>
                        ...
                        <div className="hero-content" style={{ marginTop: '1.5rem' }}>
                            ...
                            <p style={{ color: isDarkMode ? '#ffffff' : '#000000', maxWidth: '36rem', margin: '1rem auto', fontSize: '1.125rem' }}>
                                {user.bio || 'Solutions web innovantes avec passion et précision.'}
                            </p>
                            <a
                                href={user.cv || '/cv.pdf'}
                                style={{
                            ...
                            >
                                <div style={{ width: '41.666667%', padding: '0 1rem' }}>
                                    ...
                                    >
                                        ...
                                        <p style={{ fontSize: '0.875rem', color: isDarkMode ? '#d1d5db' : '#4b5563', marginBottom: '1rem' }}>
                                            {exp.description}
                                        </p>
                ...
                <section ref={aboutRef} style={{ padding: '6rem 0', position: 'relative', zIndex: 10, minHeight: '37.5rem' }}>
                    <div style={{ maxWidth: '64rem', margin: '0 auto', textAlign: 'center', padding: '0 1.5rem' }}>
                        <FallingText
                            ...
                            speed={5}
                        />
                        <p style={{ color: isDarkMode ? '#d1d5db' : '#4b5563', marginTop: '1.5rem', maxWidth: '32rem', margin: '1.5rem auto 0' }}>
                ...
                {/* Footer */}
                <footer style={{ textAlign: 'center', padding: '2rem 0', position: 'relative', zIndex: 10 }}>
...
export default NetlifyPortfolio;
